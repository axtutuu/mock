...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    value: function _init() {
       ...
       * listener
       */
      this.slider.on('panmove', function (ev) {
      ...
      for (var _i = 0; _i < items.length; _i++) {
        fragment.appendChild(items[_i].cloneNode(true));
      }
    ...
    value: function _setTransformX(x) {
      this.items.style.transform = this.items.style.webkitTransform = this.items.style.msTransform = 'translateX(' + x + 'px)';
    }
  }, {
    key: '_save',
    value: function _save(x) {
      this.x = x;
    }
  }]);
