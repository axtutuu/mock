...
function init() {
  var r = new RectangleEntity(550, 50, 50, 400, BodyStatic);
  r.color = "green";
  engine.entities.push(r);

  var rr = new RectangleEntity(0, 50, 50, 400, BodyStatic);
  rr.color = "yellow";
  engine.entities.push(rr);

  var l = new LineEntity(50, 300, 400, 350);
  l.color = "white";
  engine.entities.push(l);

  var ll = new LineEntity(500, 400, 100, 450);
  ll.color = "white";
  engine.entities.push(ll);

  for (var i = 0; i < 7; i++) {
    for (var j = 0; j < 3; j++) {
      var c = new CircleEntity(i * 60 + 100, j * 60 + 100, 5, BodyStatic);
      c.color = colors[j];
  ...
  for (var _i = 0; _i < 20; _i++) {
    var _c = new CircleEntity(rand(400) + 50, rand(200), 10, BodyDynamic);
    _c.color = colors[rand(5)];
    _c.velocity.x = rand(10) - 5;
    _c.velocity.y = rand(10) - 5;
    engine.entities.push(_c);
  }
